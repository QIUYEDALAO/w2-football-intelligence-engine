...
CURRENT_SHA = "8c6086e37ba62c138bdf059997ca760accef7067"
RECOVERY_RECEIPT_SHA = "3b38e283959394459671e441132c1e1cb9d1f019"
...
def test_production_recovery_receipt_and_state_are_complete_and_sanitized() -> None:
    ...
    for evidence in (
        f"CURRENT_MAIN_SHA = {RECOVERY_RECEIPT_SHA}",
        f"DEPLOYED_SHA = {RECOVERY_RECEIPT_SHA}",
