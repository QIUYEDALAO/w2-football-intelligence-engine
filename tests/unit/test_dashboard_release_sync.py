...
def test_dashboard_all_window_compacts_heavy_card_payload(monkeypatch) -> None:
    ...
    # The all-window index remains compact even as response-level canonical outcome
    # integrity metadata is added. Heavy per-card simulation payload stays excluded.
