...
def test_html_renderer_version_pinned() -> None:
    assert HTML_RENDERER_VERSION == "w2.html_dashboard.v4"
    ...
    assert 'name="w2-renderer" content="w2.html_dashboard.v4"' in html
    assert "renderer w2.html_dashboard.v4" in html
