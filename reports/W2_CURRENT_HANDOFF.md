...
ci_patch2_status: DERIVE_FROM_CONTAINING_COMMIT_CI
...
状态：**DERIVE_FROM_CONTAINING_COMMIT_CI**
...
本文件不得填写尚未知的新 Patch2 commit SHA；Patch2 是否关闭 CI blocker 必须以后续 GitHub Actions 状态为准。
