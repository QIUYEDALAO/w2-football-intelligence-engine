...
gate3_audit_path: archive/reports/W2_GATE3_MARKET_BASELINE_AUDIT.md
gate3_decision_path: archive/reports/W2_GATE3_MARKET_BASELINE_DECISION.json
gate3_historical_source_inventory_path: archive/reports/W2_GATE3_HISTORICAL_MARKET_SOURCE_INVENTORY.json
gate3_phase_coverage_path: archive/reports/W2_GATE3_PHASE_COVERAGE.json
gate3_ah_walk_forward_path: archive/reports/W2_GATE3_AH_WALK_FORWARD.json
gate3_historical_build_result_path: archive/reports/W2_GATE3_HISTORICAL_MARKET_BUILD_RESULT.md
...
gate3_external_source_comparison_path: archive/reports/W2_GATE3_EXTERNAL_SOURCE_COMPARISON.json
gate3_external_source_decision_path: archive/reports/W2_GATE3_EXTERNAL_SOURCE_DECISION.md
...
gate3_baselight_ai_schema_probe_path: archive/reports/W2_GATE3_BASELIGHT_AI_SCHEMA_PROBE.json
...
gate3_baselight_limited_extract_manifest_path: archive/reports/W2_GATE3_BASELIGHT_LIMITED_AH_EXTRACT_MANIFEST.json
gate3_baselight_ah_walk_forward_status: PASS_LIMITED_WALK_FORWARD
gate3_baselight_ah_walk_forward_path: archive/reports/W2_GATE3_BASELIGHT_AH_WALK_FORWARD.json
...
gate3_baselight_mcp_probe_path: archive/reports/W2_BASELIGHT_MCP_PROBE.json
...
original_workspace_last_known_dirty:
  - M archive/scripts/extract_w2_gate3_baselight_limited_ah.py
