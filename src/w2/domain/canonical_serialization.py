...
class HashDomain(StrEnum):
    ...
    MODEL_FORECAST_CAPTURE = "model_forecast.capture"
    MODEL_FORECAST_OUTCOME = "model_forecast.outcome"
    MODEL_FORECAST_XG_IDENTITY = "model_forecast.xg_identity"
    MODEL_FORECAST_INPUT_MANIFEST = "model_forecast.input_manifest"
    XG_RETENTION_STATE = "xg_retention.state"
