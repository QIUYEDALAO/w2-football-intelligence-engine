...
class DecisionReasonCode(StrEnum):
    ...
    MARKET_MOVED_AGAINST_BLIND_SPOT = "MARKET_MOVED_AGAINST_BLIND_SPOT"
    ADVISORY_DELTA_POLICY_NOT_READY = "ADVISORY_DELTA_POLICY_NOT_READY"


class DecisionRiskCode(StrEnum):
    LINEUP_UNOBSERVABLE = "LINEUP_UNOBSERVABLE"
    HIGH_ROTATION_PRIOR = "HIGH_ROTATION_PRIOR"
