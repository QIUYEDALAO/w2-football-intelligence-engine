        ...
        *,
        ...
        for item in response:
            ...
            if not isinstance(fixture, dict):
                # stated rather than implied: the id lookup below already skipped a
                # non-dict fixture, but the later date lookup relied on that being
                # obvious. The merge brought both readers into one function.
                continue
