...
def _html_non_formal_decision_table(
    ...
    headers = (
        ...
        "outcome_tracked",
        "lock_eligible",
        "decision_contract.reason_code",
        "decision_contract.action",
        "decision_contract.next_eval_at",
...
def _non_formal_table_row(match: dict[str, Any], decision: MatchDecision) -> tuple[str, ...]:
    ...
    return (
        ...
        _text(match.get("decision_tier")),
        _text(match.get("data_status")),
        _join_codes(match.get("missing_fields")),
        _join_codes(match.get("stale_fields")),
        _text(match.get("lifecycle_status")),
        _text(match.get("outcome_tracked")),
        _text(match.get("lock_eligible")),
        _text(match.get("reason_code")),
