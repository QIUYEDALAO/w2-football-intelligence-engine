...
def fit_and_predict_r4_1(train_samples, val_samples) -> dict:
    ...
    model = fit_r4_1_lambda_model(train_samples, min_sample=MIN_LAMBDA_FIT_SAMPLE)
    train_raw = r4_1_predictions(train_samples, model)
    val_raw = r4_1_predictions(val_samples, model)
...
def eval_protocol(
    ...
    if r4_1_result is not None:
        report["r4_1"] = {
            ...
            "policy": {
                "dixon_coles_rho": rho_from_r4_1(r4_1_result["model"]),
