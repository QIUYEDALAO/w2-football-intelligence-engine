...
The trusted external capture verification hotfix is also complete: PR #417 was
accepted at `b614c490e46f94835a729d3079b2aa71fe9213da`, passed Full CI
`30266575034`, and merged as
`62a9c0ac5a85426fb44234ec7a0032454d605a59`; main `CI_REQUIRED` run
`30268052489` and POST run `30268052524` passed. **ARCH-GOVERNANCE-03** is
therefore `DONE`. **ARCH-P1-03B-R1** is the current task but remains
`NOT_STARTED`; PR #414 remains Draft and unchanged by this closure.
