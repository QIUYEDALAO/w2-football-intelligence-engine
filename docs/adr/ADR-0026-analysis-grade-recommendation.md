...
expected value. It is disabled by default and is not part of the analysis-card
...
- Market movement, team state, goal rates, fitness, settled cover history, H2H,
  and data availability all contribute transparently.
- Missing H2H or team-value data is disclosed as unavailable and contributes
  zero; the system must not invent data.
