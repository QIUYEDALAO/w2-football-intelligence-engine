...
| `api` | 6 | apps:2;scripts:3;migrations:0;tests:22 | - | competitions,dashboard,domain,identity,infrastructure,lineups,matchday,models,monitoring,operations,prematch,providers,replay,settlement,tracking | - | - | YES | YES | PYTHON_IMAGE | PUBLIC_READ | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `dashboard` | 18 | apps:1;scripts:2;migrations:0;tests:22 | api,matchday,prematch,replay | competitions,domain,prematch,settlement,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | PUBLIC_READ | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `identity` | 4 | apps:0;scripts:1;migrations:1;tests:6 | api,factor_model,historical,ingestion,lineups,prematch | domain,infrastructure | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `infrastructure` | 21 | apps:1;scripts:27;migrations:18;tests:67 | api,audit_export,competitions,factor_model,historical,identity,ingestion,matchday,monitoring,operations,prematch,providers,quant_research,replay,settlement,strategy,tracking | domain | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `prematch` | 11 | apps:2;scripts:15;migrations:0;tests:45 | api,dashboard,ingestion,matchday,operations,replay,tracking | analysis,competitions,dashboard,domain,features,formal,historical,identity,infrastructure,ingestion,lineups,markets,matchday,operations,pricing,providers,ratings,settlement,strategy,tracking | SCC-1 | - | YES | YES | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `quant_research` | 3 | apps:1;scripts:1;migrations:0;tests:4 | - | domain,historical,infrastructure,ingestion | - | - | YES | NO | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;F1R_B_SUCCESSOR_PRODUCTION_FACTOR_RECORDING;AST_DEPENDENCY_GRAPH |
