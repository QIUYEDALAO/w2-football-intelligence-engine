...
| `markets` | 18 | apps:0;scripts:9;migrations:0;tests:24 | analysis,backtest,features,historical,ingestion,prematch,readiness,strategy,tracking | domain,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
