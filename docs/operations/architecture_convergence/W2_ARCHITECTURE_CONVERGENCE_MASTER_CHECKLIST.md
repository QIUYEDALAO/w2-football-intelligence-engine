...
| `backtest` | 11 | apps:0;scripts:9;migrations:0;tests:11 | - | competitions,domain,factor_model,ingestion,markets,models,providers | - | - | NO | NO | PYTHON_IMAGE | OFFLINE_TOOL | KEEP_OFFLINE | 9_SCRIPT_ENTRIES;HISTORICAL_RAW_CONSUMER |
...
| `models` | 12 | apps:0;scripts:4;migrations:0;tests:8 | api,backtest,factor_model,operations,recovery,strategy | domain | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
