...
| `api` | 6 | apps:2;scripts:3;migrations:0;tests:25 | - | competitions,dashboard,domain,identity,infrastructure,lineups,matchday,models,monitoring,operations,prematch,providers,replay,tracking | - | - | YES | YES | PYTHON_IMAGE | PUBLIC_READ | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `competitions` | 9 | apps:1;scripts:20;migrations:2;tests:31 | api,backtest,dashboard,features,ingestion,matchday,monitoring,operations,prematch,strategy | infrastructure,providers | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `dashboard` | 19 | apps:1;scripts:2;migrations:0;tests:23 | api,matchday,prematch,replay | competitions,domain,identity,prematch,settlement,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | PUBLIC_READ | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `domain` | 23 | apps:0;scripts:24;migrations:0;tests:46 | analysis,api,audit_export,backtest,dashboard,factor_model,features,historical,identity,infrastructure,ingestion,markets,matchday,migration,models,monitoring,normalization,operations,prematch,pricing,quant_research,readiness,recovery,replay,reporting,schemas,settlement,strategy,tracking | lineups,readiness,tracking | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `factor_model` | 2 | apps:0;scripts:2;migrations:0;tests:1 | - | domain,features,historical,identity,infrastructure,ingestion,matchday,providers,ratings | - | - | NO | NO | PYTHON_IMAGE | OFFLINE_TOOL | KEEP_OFFLINE | SCRIPT_ENTRY;OFFLINE_REMEDIATION |
| `features` | 8 | apps:0;scripts:6;migrations:0;tests:7 | factor_model,ingestion,prematch,ratings,strategy | competitions,domain,markets | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `historical` | 14 | apps:1;scripts:9;migrations:0;tests:6 | factor_model,lineups,prematch,quant_research | domain,identity,infrastructure,markets | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `identity` | 4 | apps:0;scripts:1;migrations:1;tests:6 | api,dashboard,factor_model,historical,ingestion,lineups,prematch | domain,infrastructure | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `infrastructure` | 21 | apps:1;scripts:27;migrations:18;tests:70 | api,audit_export,competitions,factor_model,historical,identity,ingestion,matchday,monitoring,operations,prematch,providers,quant_research,replay,settlement,strategy,tracking | domain | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `ingestion` | 18 | apps:2;scripts:15;migrations:0;tests:27 | analysis,backtest,factor_model,matchday,prematch,providers,quant_research,replay,tracking | competitions,domain,features,identity,infrastructure,lineups,markets,matchday,normalization,operations,prematch,providers | SCC-1 | - | YES | YES | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `markets` | 19 | apps:0;scripts:9;migrations:0;tests:23 | analysis,backtest,features,historical,ingestion,prematch,readiness,strategy,tracking | domain,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
| `matchday` | 10 | apps:1;scripts:4;migrations:3;tests:14 | api,factor_model,ingestion,prematch,refresh | competitions,dashboard,domain,infrastructure,ingestion,prematch,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_ENTRYPOINT | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `models` | 12 | apps:0;scripts:2;migrations:0;tests:9 | api,backtest,operations,quant_research,recovery,strategy | domain | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `prematch` | 11 | apps:2;scripts:15;migrations:0;tests:46 | api,dashboard,ingestion,matchday,operations,replay,tracking | analysis,competitions,dashboard,domain,features,formal,historical,identity,infrastructure,ingestion,lineups,markets,matchday,operations,pricing,providers,ratings,settlement,strategy,tracking | SCC-1 | - | YES | YES | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `quant_research` | 5 | apps:1;scripts:1;migrations:0;tests:6 | - | domain,historical,infrastructure,ingestion,models | - | - | YES | NO | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;F1R_B_SUCCESSOR_PRODUCTION_FACTOR_RECORDING;AST_DEPENDENCY_GRAPH |
...
| `replay` | 3 | apps:0;scripts:3;migrations:0;tests:4 | api | dashboard,domain,infrastructure,ingestion,prematch,providers,tracking | - | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;READ_ONLY_REPLAY_FRONT_DOOR |
...
| `strategy` | 15 | apps:1;scripts:4;migrations:0;tests:28 | dashboard,gates,markets,matchday,operations,prematch,pricing,shadow | competitions,domain,features,formal,infrastructure,markets,models,pricing | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
DECISION_COUNTS = KEEP:29;KEEP_OFFLINE:10;KEEP_MIGRATION:1;KEEP_AUDIT:1;DELETE:0
CYCLE_1_MEMBERS = analysis,competitions,dashboard,domain,features,historical,identity,infrastructure,ingestion,lineups,markets,matchday,models,normalization,operations,prematch,pricing,providers,ratings,readiness,refresh,settlement,strategy,tracking
DEAD_PACKAGES = NONE
...
- [x] 已知保留项如实登记：当前 1 个 24 包 SCC 未重构；`schemas` 保持
...
INT_JSON_NUMBER_FLOAT64_BIG_ENDIAN_HEX_DECIMAL_CONTEXT_FREE_DATE_DATETIME_BYTES_TYPED_UNSUPPORTED_REJECTED

HASH_DOMAIN_IN_PREIMAGE = false
SERIALIZER_VERSION_IN_PREIMAGE = false
HASH_DOMAIN_AND_SERIALIZER_VERSION_METADATA_REQUIRED = true
PAIR_IDENTITY_HASH_DOMAIN = eval_02b.pair_identity

PAIR_PROJECTOR_SCHEMA =
w2.eval_02b_exact_pair_projection.v2
