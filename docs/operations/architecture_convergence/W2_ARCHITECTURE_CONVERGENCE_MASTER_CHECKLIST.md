...
| `factor_model` | 2 | apps:0;scripts:2;migrations:0;tests:1 | - | domain,features,historical,identity,infrastructure,ingestion,markets,matchday,providers,ratings | - | - | NO | NO | PYTHON_IMAGE | OFFLINE_TOOL | KEEP_OFFLINE | SCRIPT_ENTRY;OFFLINE_REMEDIATION |
...
| `historical` | 13 | apps:0;scripts:9;migrations:0;tests:5 | factor_model,lineups,prematch,quant_research | domain,identity,infrastructure | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `markets` | 19 | apps:0;scripts:9;migrations:0;tests:22 | analysis,backtest,factor_model,features,ingestion,prematch,readiness,strategy,tracking | domain,strategy | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `prematch` | 10 | apps:2;scripts:14;migrations:0;tests:42 | api,dashboard,ingestion,matchday,operations,replay,tracking | analysis,competitions,dashboard,domain,features,formal,historical,identity,infrastructure,ingestion,lineups,markets,matchday,operations,pricing,providers,ratings,settlement,strategy,tracking | SCC-1 | - | YES | YES | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `quant_research` | 3 | apps:1;scripts:1;migrations:0;tests:3 | - | domain,historical,infrastructure,ingestion | - | - | YES | NO | PYTHON_IMAGE | WRITE_SIDE_PROJECTION | KEEP | RUNTIME_REACHABLE;F1R_B_SUCCESSOR_PRODUCTION_FACTOR_RECORDING;AST_DEPENDENCY_GRAPH |
