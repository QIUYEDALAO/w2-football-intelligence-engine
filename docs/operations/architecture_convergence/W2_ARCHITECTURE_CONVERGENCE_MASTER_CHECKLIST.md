...
| `backtest` | 11 | apps:0;scripts:8;migrations:0;tests:11 | - | competitions,domain,factor_model,ingestion,markets,models,providers,strategy | - | - | NO | NO | PYTHON_IMAGE | OFFLINE_TOOL | KEEP_OFFLINE | 8_SCRIPT_ENTRIES;HISTORICAL_RAW_CONSUMER |
| `competitions` | 9 | apps:1;scripts:15;migrations:2;tests:27 | api,backtest,dashboard,features,ingestion,matchday,monitoring,operations,prematch,strategy | infrastructure,providers | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `factor_model` | 5 | apps:0;scripts:6;migrations:0;tests:8 | backtest | domain,features,identity,infrastructure,ingestion,matchday,providers,ratings | - | - | NO | NO | PYTHON_IMAGE | OFFLINE_TOOL | KEEP_OFFLINE | SCRIPT_ENTRY;OFFLINE_REMEDIATION |
...
| `models` | 12 | apps:0;scripts:3;migrations:0;tests:8 | api,backtest,operations,recovery,strategy | domain | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
| `strategy` | 13 | apps:0;scripts:4;migrations:0;tests:15 | backtest,dashboard,gates,markets,matchday,prematch,pricing,shadow | competitions,domain,features,formal,infrastructure,markets,models | SCC-1 | - | YES | YES | PYTHON_IMAGE | RUNTIME_LIBRARY | KEEP | RUNTIME_REACHABLE;AST_DEPENDENCY_GRAPH |
...
DECISION_COUNTS = KEEP:28;KEEP_OFFLINE:10;KEEP_MIGRATION:1;KEEP_AUDIT:1;DELETE:0
