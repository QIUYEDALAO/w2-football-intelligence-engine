...
w2-shadow-comparison-import \
  --artifact /opt/w2/shared/runtime/comparison/sanitized.json \
  --manifest /opt/w2/shared/runtime/comparison/manifest.json \
  --artifact-root /opt/w2/shared/runtime/comparison \
  --dry-run \
  --json
```
