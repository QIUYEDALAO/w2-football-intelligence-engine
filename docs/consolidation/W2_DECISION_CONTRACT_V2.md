...
- staging 重部署硬回滚条件包括 API OOM/exit 137/restart/oom_kill 增量、原 OOM fixture 5xx、响应超限、L1/L2 identity 不一致、denominator 或三轨污染，以及任何 RECOMMEND、lock、OFFICIAL、历史 rewrite 或 secret 泄漏。
